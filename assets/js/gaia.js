...
$(document).ready(function() {
    ...
    $('.locations').each(function() {
        ...
        gaia.initGoogleMaps(this, lat, lng, info);
    });
...
gaia = {
    ...
    initGoogleMaps: function($elem, lat, lng, info) {
        ...
        var contentString = '<div>' +
            '<p><b>' + info +
            '</b></p>' +
            '<table> <td><i class="fa fa-phone"></td> <td>88017218</td> </tr> <tr> <td><i class="fa fa-envelope"></td> <td>info@demyouth.mn</td> </tr> </table>'
        '</div>';
